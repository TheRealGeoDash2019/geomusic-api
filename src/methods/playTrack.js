...
module.exports = async (token, jsonData) => {
  ...
  /*
    myJSON = {
      ...
      //REQUIRED: The Track to be Played
  ...
  */
  ...
  if (jsonData && jsonData?.user !== null && jsonData?.guild !== null) requestJSON = {
    ...
    "track": jsonData?.loopMode?.toString()
  }
  
  let response = await got("https://geomusic.geoanything.page/api/v1/player/play", {headers: Headers, json: requestJSON, method: "POST"})
