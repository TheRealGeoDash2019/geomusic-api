...
module.exports = async (token, jsonData) => {
  ...
  /*
    myJSON = {
      ...
      //REQUIRED: The Volume for the Audio Playing
      "volume": 100
    }
  */
  ...
  if (jsonData && jsonData?.user !== null && jsonData?.guild !== null) requestJSON = {
    ...
    "volume": parseInt(jsonData?.volume)
  }
  
  let response = await got("https://geomusic.geoanything.page/api/v1/player/volume", {headers: Headers, json: requestJSON, method: "POST"})
